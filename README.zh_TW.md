...
The goal of this project is to translate the Linux Kernel Documentation into multiple languages. 翻譯是在 Crowdin 平臺上進行貢獻，然後會自動與 GitHub 儲存庫進行同步，並且可以在 GitHub Pages 上進行預覽。
...
<ul>
  ...
  <li>如果您知道如何修正臭蟲，請在 <a href="https://github.com/localizethedocs/linux-docs-l10n/pulls">GitHub</a> 上提交拉取請求。</li>
