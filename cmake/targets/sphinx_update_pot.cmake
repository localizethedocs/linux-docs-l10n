...
set(SPHINX_INDEX_RST_FILE "${PROJ_OUT_REPO_DOCS_SOURCE_DIR}/index.rst")
file(READ "${SPHINX_INDEX_RST_FILE}" SPHINX_INDEX_RST_CNT)
...
string(REGEX MATCH "${TRANSLATION_SECTION_REGEX}" OLD_TRANSLATION_SECTION "${SPHINX_INDEX_RST_CNT}")
if (OLD_TRANSLATION_SECTION)
    string(REGEX REPLACE "${TRANSLATION_SECTION_REGEX}" "" NEW_TRANSLATION_SECTION "${OLD_TRANSLATION_SECTION}")
    string(REGEX REPLACE "${TRANSLATION_SECTION_REGEX}" "${NEW_TRANSLATION_SECTION}" SPHINX_INDEX_RST_CNT "${SPHINX_INDEX_RST_CNT}")
    file(WRITE "${SPHINX_INDEX_RST_FILE}" "${SPHINX_INDEX_RST_CNT}")
    remove_cmake_message_indent()
    message("")
    message("Removed 'Translations' section in 'Documentation/index.rst' file.")
    message("File: ${SPHINX_INDEX_RST_FILE}")
    message("")
...
message(STATUS "Removing directory '${PROJ_OUT_REPO_DOCS_DIR}/translations/'...")
if (EXISTS "${PROJ_OUT_REPO_DOCS_DIR}/translations")
    file(REMOVE_RECURSE "${PROJ_OUT_REPO_DOCS_DIR}/translations")
    remove_cmake_message_indent()
    message("")
    message("Removed directory '${PROJ_OUT_REPO_DOCS_DIR}/translations/'.")
    message("")
    restore_cmake_message_indent()
else()
    remove_cmake_message_indent()
    message("")
    message("No need to removed directory '${PROJ_OUT_REPO_DOCS_DIR}/translations/'.")
    message("")
    restore_cmake_message_indent()
endif()
